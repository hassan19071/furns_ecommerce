        ...
        <div className="products-container">
          <div className="status">
            <ul className="list-unstyled d-flex justify-content-center">
              <li
                className={activePros === 0 ? "active" : ""}
                onClick={() => handleActivePros(0)}
              >
                New Arrival
              </li>
              <li
                className={activePros === 1 ? "active" : ""}
                onClick={() => handleActivePros(1)}
              >
                Featured
              </li>
              <li
                className={activePros === 2 ? "active" : ""}
                onClick={() => handleActivePros(2)}
              >
                On Sale
              </li>
              <li
                className={activePros === 3 ? "active" : ""}
                onClick={() => handleActivePros(3)}
              >
                Trending
              </li>
            </ul>
